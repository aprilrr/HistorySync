...
#[derive(Debug)]
pub struct HistorySyncProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HistorySyncProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HistorySync processing");
    
    let mut processor = HistorySyncProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HistorySyncProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HistorySyncProcessor::new(false);
